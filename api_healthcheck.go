...
*/
func (a *HealthcheckApiService) RootGet(ctx context.Context) ApiRootGetRequest {
	return ApiRootGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *HealthcheckApiService) RootGetExecute(r ApiRootGetRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HealthcheckApiService.RootGet")
	if err != nil {
